...
_Note: your application must include [jQuery](http://jquery.com/) for the plugin to work properly,
either through the [`jquery-rails` gem](https://github.com/rails/jquery-rails), or some other means._
